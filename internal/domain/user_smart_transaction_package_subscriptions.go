...
type UserSmartTransactionPackageSubscriptions struct {
...
func (UserSmartTransactionPackageSubscriptions) TableName() string {
	return "user_smart_transaction_package_subscriptions"
}
